...
| `confirmCloseWindow` | Optional | Boolean | `false` | When set to `true` closing a window will require confirmation. When set to `false`, the confirmation dialog will not appear. |
